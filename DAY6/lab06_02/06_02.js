...
// 배열의 length 프로퍼티에 현재 배열들의 개수보다 적고 0보다 큰 정수값을 넣으면 배열의 길이가 줄어든다.
...
// list3과 list4를 비교해보자.
// 값도 같고, 타입도 같아서 아주 완벽하게 똑같을때 비교하는 것이 ===(동치)이다.
console.log(list3 === list4);
